...
class MusicReportModel(models.Model):
    objects = DeveloperManager()
    ...
    parsed_text = models.TextField(max_length = 5000, default = "Name of file for generating music")
    parsed_music = models.TextField(max_length = 5000)
    report = JSONField({})
    def __str__(self):
        return self.timing